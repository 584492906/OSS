...
import com.shinowit.services.RoleUpdateService;
...
public class UpdateRoleAction extends ActionSupport {
    ...
    public String updateRole() {
        ...
        try {
            ...
            result = service.UpRoleAuthor(role, author);
    ...
    public RoleUpdateService getService() {
        return service;
    }

    public void setService(RoleUpdateService service) {
